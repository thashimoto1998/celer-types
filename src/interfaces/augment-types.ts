...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    PayInfoOf: PayInfoOf;
    'Option<PayInfoOf>': Option<PayInfoOf>;
    'Vec<PayInfoOf>': Vec<PayInfoOf>;
    Wallet: Wallet;
    'Option<Wallet>': Option<Wallet>;
    'Vec<Wallet>': Vec<Wallet>;
    WalletOf: WalletOf;
    'Option<WalletOf>': Option<WalletOf>;
    'Vec<WalletOf>': Vec<WalletOf>;
    ...
    AccountAmtPair: AccountAmtPair;
    'Option<AccountAmtPair>': Option<AccountAmtPair>;
    'Vec<AccountAmtPair>': Vec<AccountAmtPair>;
    TokenTransfer: TokenTransfer;
    'Option<TokenTransfer>': Option<TokenTransfer>;
    'Vec<TokenTransfer>': Vec<TokenTransfer>;
    TransferFunctionType: TransferFunctionType;
    'Option<TransferFunctionType>': Option<TransferFunctionType>;
    'Vec<TransferFunctionType>': Vec<TransferFunctionType>;
    TransferFunction: TransferFunction;
    'Option<TransferFunction>': Option<TransferFunction>;
    'Vec<TransferFunction>': Vec<TransferFunction>;
    ConditionalPay: ConditionalPay;
    'Option<ConditionalPay>': Option<ConditionalPay>;
    'Vec<ConditionalPay>': Vec<ConditionalPay>;
    ConditionalPayOf: ConditionalPayOf;
    'Option<ConditionalPayOf>': Option<ConditionalPayOf>;
    'Vec<ConditionalPayOf>': Vec<ConditionalPayOf>;
    ResolvePaymentConditionsRequest: ResolvePaymentConditionsRequest;
    'Option<ResolvePaymentConditionsRequest>': Option<ResolvePaymentConditionsRequest>;
    'Vec<ResolvePaymentConditionsRequest>': Vec<ResolvePaymentConditionsRequest>;
    ResolvePaymentConditionsRequestOf: ResolvePaymentConditionsRequestOf;
    'Option<ResolvePaymentConditionsRequestOf>': Option<ResolvePaymentConditionsRequestOf>;
    'Vec<ResolvePaymentConditionsRequestOf>': Vec<ResolvePaymentConditionsRequestOf>;
    CondPayResult: CondPayResult;
    'Option<CondPayResult>': Option<CondPayResult>;
    'Vec<CondPayResult>': Vec<CondPayResult>;
    VouchedCondPayResult: VouchedCondPayResult;
    'Option<VouchedCondPayResult>': Option<VouchedCondPayResult>;
    'Vec<VouchedCondPayResult>': Vec<VouchedCondPayResult>;
    VouchedCondPayResultOf: VouchedCondPayResultOf;
    'Option<VouchedCondPayResultOf>': Option<VouchedCondPayResultOf>;
    'Vec<VouchedCondPayResultOf>': Vec<VouchedCondPayResultOf>;
    TokenDistribution: TokenDistribution;
    'Option<TokenDistribution>': Option<TokenDistribution>;
    'Vec<TokenDistribution>': Vec<TokenDistribution>;
    PaymentChannelInitializer: PaymentChannelInitializer;
    'Option<PaymentChannelInitializer>': Option<PaymentChannelInitializer>;
    'Vec<PaymentChannelInitializer>': Vec<PaymentChannelInitializer>;
    PaymentChannelInitializerOf: PaymentChannelInitializerOf;
    'Option<PaymentChannelInitializerOf>': Option<PaymentChannelInitializerOf>;
    'Vec<PaymentChannelInitializerOf>': Vec<PaymentChannelInitializerOf>;
    OpenChannelRequest: OpenChannelRequest;
    'Option<OpenChannelRequest>': Option<OpenChannelRequest>;
    'Vec<OpenChannelRequest>': Vec<OpenChannelRequest>;
    OpenChannelRequestOf: OpenChannelRequestOf;
    'Option<OpenChannelRequestOf>': Option<OpenChannelRequestOf>;
    'Vec<OpenChannelRequestOf>': Vec<OpenChannelRequestOf>;
    PayIdList: PayIdList;
    'Option<PayIdList>': Option<PayIdList>;
    'Vec<PayIdList>': Vec<PayIdList>;
    SimplexPaymentChannel: SimplexPaymentChannel;
    'Option<SimplexPaymentChannel>': Option<SimplexPaymentChannel>;
    'Vec<SimplexPaymentChannel>': Vec<SimplexPaymentChannel>;
    SignedSimplexState: SignedSimplexState;
    'Option<SignedSimplexState>': Option<SignedSimplexState>;
    'Vec<SignedSimplexState>': Vec<SignedSimplexState>;
    SignedSimplexStateArray: SignedSimplexStateArray;
    'Option<SignedSimplexStateArray>': Option<SignedSimplexStateArray>;
    'Vec<SignedSimplexStateArray>': Vec<SignedSimplexStateArray>;
    SignedSimplexStateArrayOf: SignedSimplexStateArrayOf;
    'Option<SignedSimplexStateArrayOf>': Option<SignedSimplexStateArrayOf>;
    'Vec<SignedSimplexStateArrayOf>': Vec<SignedSimplexStateArrayOf>;
    CooperativeWithdrawInfo: CooperativeWithdrawInfo;
    'Option<CooperativeWithdrawInfo>': Option<CooperativeWithdrawInfo>;
    'Vec<CooperativeWithdrawInfo>': Vec<CooperativeWithdrawInfo>;
    CooperativeWithdrawInfoOf: CooperativeWithdrawInfoOf;
    'Option<CooperativeWithdrawInfoOf>': Option<CooperativeWithdrawInfoOf>;
    'Vec<CooperativeWithdrawInfoOf>': Vec<CooperativeWithdrawInfoOf>;
    CooperativeWithdrawRequest: CooperativeWithdrawRequest;
    'Option<CooperativeWithdrawRequest>': Option<CooperativeWithdrawRequest>;
    'Vec<CooperativeWithdrawRequest>': Vec<CooperativeWithdrawRequest>;
    CooperativeWithdrawRequestOf: CooperativeWithdrawRequestOf;
    'Option<CooperativeWithdrawRequestOf>': Option<CooperativeWithdrawRequestOf>;
    'Vec<CooperativeWithdrawRequestOf>': Vec<CooperativeWithdrawRequestOf>;
    CooperativeSettleInfo: CooperativeSettleInfo;
    'Option<CooperativeSettleInfo>': Option<CooperativeSettleInfo>;
    'Vec<CooperativeSettleInfo>': Vec<CooperativeSettleInfo>;
    CooperativeSettleInfoOf: CooperativeSettleInfoOf;
    'Option<CooperativeSettleInfoOf>': Option<CooperativeSettleInfoOf>;
    'Vec<CooperativeSettleInfoOf>': Vec<CooperativeSettleInfoOf>;
    CooperativeSettleRequest: CooperativeSettleRequest;
    'Option<CooperativeSettleRequest>': Option<CooperativeSettleRequest>;
    'Vec<CooperativeSettleRequest>': Vec<CooperativeSettleRequest>;
    CooperativeSettleRequestOf: CooperativeSettleRequestOf;
    'Option<CooperativeSettleRequestOf>': Option<CooperativeSettleRequestOf>;
    'Vec<CooperativeSettleRequestOf>': Vec<CooperativeSettleRequestOf>;
    ChannelStatus: ChannelStatus;
    'Option<ChannelStatus>': Option<ChannelStatus>;
    'Vec<ChannelStatus>': Vec<ChannelStatus>;
    PeerState: PeerState;
    'Option<PeerState>': Option<PeerState>;
    'Vec<PeerState>': Vec<PeerState>;
    PeerStateOf: PeerStateOf;
    'Option<PeerStateOf>': Option<PeerStateOf>;
    'Vec<PeerStateOf>': Vec<PeerStateOf>;
    PeerProfile: PeerProfile;
    'Option<PeerProfile>': Option<PeerProfile>;
    'Vec<PeerProfile>': Vec<PeerProfile>;
    PeerProfileOf: PeerProfileOf;
    'Option<PeerProfileOf>': Option<PeerProfileOf>;
    'Vec<PeerProfileOf>': Vec<PeerProfileOf>;
    WithdrawIntent: WithdrawIntent;
    'Option<WithdrawIntent>': Option<WithdrawIntent>;
    'Vec<WithdrawIntent>': Vec<WithdrawIntent>;
    WithdrawIntentOf: WithdrawIntentOf;
    'Option<WithdrawIntentOf>': Option<WithdrawIntentOf>;
    'Vec<WithdrawIntentOf>': Vec<WithdrawIntentOf>;
    ChannelOf: ChannelOf;
